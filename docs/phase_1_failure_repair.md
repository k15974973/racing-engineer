...
- `part_damage`: block, induction, and material wear from 0 to 100 each.
...
- The current setup's block, induction, and material stress profile.
...
Part wear modifies the penalty shape:
