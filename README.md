...
The project currently includes Phase 0, the canonical Phase 1 Engine Builder slice, the canonical Phase 2 Race Sim slice, and future-phase vertical prototype systems:
...
Phase 2 Race Sim is complete for the canonical roadmap deliverable: end-to-end build, race, and result flow on two tracks. Analysis, race history, progression unlocks, garage economy, repair, Hybrid slot condition, and service events are running prototype systems for later phases or a possible roadmap extension.
